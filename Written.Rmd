...
### 4. Visualization
Based on those summarized table created in part 2, I use "ggplot" to visualize three type of relationship discovered in this "County-level oil and gas production" dataset. The first one is a bar graph with oil and gas side by side to illustrate how the national mean production varied year to year and compare the differences between oil and gas production.
![](E:\2016 Fall\MA415\Midterm Project Oil Gas Production\Oil Production vs. Gas Production.png)
The Second is a pair of graphs showing the mean production level of oil and gas in different county level.
![](E:\2016 Fall\MA415\Midterm Project Oil Gas Production\Oil Production by County Level.png)
![](E:\2016 Fall\MA415\Midterm Project Oil Gas Production\Gas Production by County Level.png)
The third is a pair of graphs showing the change in oil and gas production for each county level from 2000 to 2011.
![](E:\2016 Fall\MA415\Midterm Project Oil Gas Production\Oil Production By Year.png)
![](E:\2016 Fall\MA415\Midterm Project Oil Gas Production\Oil Production by Year.png)
